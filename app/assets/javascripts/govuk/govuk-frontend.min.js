...
function extractConfigByNamespace(Component, t, e) {
  ...
  for (const [i, o] of Object.entries(t)) {
    ...
    for (const [n, r] of s.entries())
      "object" == typeof t &&
        (n < s.length - 1
          ? (isObject(t[r]) || (t[r] = {}), (t = t[r]))
          : i !== e && (t[r] = normaliseString(o)));
  }
  return n[e];
}
...
function setFocus(t, e = {}) {
  ...
  n || t.setAttribute("tabindex", "-1"),
    ...
    null == (s = e.onBeforeFocus) || s.call(t),
    t.focus();
}
...
function normaliseDataset(Component, t) {
  const e = {};
  for (const [s, n] of Object.entries(Component.schema.properties))
    s in t && (e[s] = normaliseString(t[s], n)),
      "object" === (null == n ? void 0 : n.type) &&
        (e[s] = extractConfigByNamespace(Component, t, s));
  return e;
}
...
class I18n {
  constructor(t = {}, e = {}) {
    ...
    (this.translations = void 0),
      ...
      (this.translations = t),
      (this.locale =
        null != (s = e.locale) ? s : document.documentElement.lang || "en");
  }
  t(t, e) {
...
class Accordion extends GOVUKFrontendComponent {
  ...
  initSectionHeaders() {
    this.$sections.forEach((t, e) => {
      ...
      this.constructHeaderMarkup(s, e),
        this.setExpanded(this.isExpanded(t), t),
        s.addEventListener("click", () => this.onSectionToggle(t)),
  ...
  constructHeaderMarkup(t, e) {
    ...
    a.classList.add(this.sectionHeadingTextFocusClass),
      r.appendChild(a),
      Array.from(s.childNodes).forEach((t) => a.appendChild(t));
    ...
    if (
      ...
      Array.from(i.childNodes).forEach((t) => e.appendChild(t)),
        i.remove(),
        o.appendChild(t),
        o.appendChild(this.getButtonPunctuationEl());
    }
  ...
  constructor(t, e = {}) {
    ...
    const a = (function (t, e) {
      ...
      for (const [n, i] of Object.entries(t)) {
        const t = [];
        if (Array.isArray(i)) {
          for (const { required: s, errorMessage: n } of i)
            s.every((t) => !!e[t]) || t.push(n);
    ...
    (this.i18n = new I18n(this.config.i18n, {
      ...
      (this.maxLength =
        null !=
        (s = null != (n = this.config.maxwords) ? n : this.config.maxlength)
          ? s
          : 1 / 0),
      (this.$textarea = i);
  ...
  syncConditionalRevealWithInputState(t) {
    ...
    if (null != s && s.classList.contains("govuk-checkboxes__conditional")) {
      ...
      t.setAttribute("aria-expanded", e.toString()),
        s.classList.toggle("govuk-checkboxes__conditional--hidden", !e);
    }
  }
...
class Radios extends GOVUKFrontendComponent {
  ...
  syncConditionalRevealWithInputState(t) {
    ...
    if (null != s && s.classList.contains("govuk-radios__conditional")) {
      const e = t.checked;
      t.setAttribute("aria-expanded", e.toString()),
        s.classList.toggle("govuk-radios__conditional--hidden", !e);
    }
  }
  handleClick(t) {
    const e = t.target;
...
class Tabs extends GOVUKFrontendComponent {
  ...
  activateNextTab() {
    ...
    s &&
      (this.hideTab(t), this.showTab(s), s.focus(), this.createHistoryEntry(s));
  }
  activatePreviousTab() {
    const t = this.getCurrentTab();
    if (null == t || !t.parentElement) return;
...
function createAll(Component, t, e) {
  ...
  var i;
  "object" == typeof e &&
    ((n = null != (i = e.scope) ? i : n), (s = e.onError));
    ...
    ? Array.from(o)
        .map((e) => {
          try {
            ...
            return (
              s
                ? s(n, { element: e, component: Component, config: t })
                : console.log(n),
              null
            );
          }
        ...
        .filter(Boolean)
    : (s
        ? s(new SupportError(), { component: Component, config: t })
        : console.log(new SupportError()),
      []);
}
